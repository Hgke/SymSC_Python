...
class OR(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        ...
        self.add_JJ(name='J1', c=1, A=2, B=0, loc=[sk[7], 0])
        self.add_JJ(name='J2', c=1, A=1.408, B=0, loc=[sk[6], 0])
        self.add_JJ(name='J3', c=1, A=1.408, B=0, loc=[sk[0], sk[7]])
        self.add_JJ(name='J4', c=1, A=1.408, B=0, loc=[sk[5], sk[6]])
        self.add_JJ(name='J5', c=1, A=2, B=0, loc=[sk[8], 0])
        self.add_JJ(name='J6', c=1, A=1.408, B=0, loc=[sk[4], 0])
        self.add_JJ(name='J7', c=1, A=1.408, B=0, loc=[sk[2], sk[8]])
        self.add_JJ(name='J8', c=1, A=1.408, B=0, loc=[sk[13], sk[4]])
        self.add_JJ(name='J9', c=1, A=1.408, B=0, loc=[sk[11], 0])
        self.add_JJ(name='J10', c=1, A=1.408, B=0, loc=[sk[11], sk[12]])
        self.add_JJ(name='J11', c=1, A=1.408, B=0, loc=[sk[9], 0])
        self.add_JJ(name='J12', c=1, A=1.408, B=0, loc=[sk[9], sk[10]])
