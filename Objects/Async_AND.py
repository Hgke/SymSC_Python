...
class Async_AND(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        ...
        self.add_JJ(name='J1', c=1, A=0.672, B=0, loc=[sk[3], sk[2]])
        self.add_JJ(name='J2', c=1, A=0.672, B=0, loc=[sk[5], sk[2]])
        self.add_JJ(name='J3', c=1, A=1.5, B=0, loc=[sk[2], 0])
        self.add_JJ(name='JD1', c=1, A=0.48, B=0, loc=[sk[4], sk[2]])
        self.add_JJ(name='JD2', c=1, A=0.48, B=0, loc=[sk[6], sk[2]])

        self.add_L(name='L1', val=2, loc=[sk[0], sk[3]])
        self.add_L(name='L2', val=2, loc=[sk[1], sk[5]])
