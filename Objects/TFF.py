...
class TFF(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        self.add_JJ(name='J2', c=1, A=1, B=0, loc=[sk[3], sk[4]])
        self.add_JJ(name='J4', c=1, A=1, B=0, loc=[sk[3], sk[6]])
        self.add_JJ(name='J1', c=1, A=1.5, B=0, loc=[sk[4], 0])
        self.add_JJ(name='J3', c=1, A=1.5, B=0, loc=[sk[6], 0])
