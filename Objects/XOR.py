...
class XOR(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        ...
        self.add_JJ(name='J0', c=1, A=1.6, B=0, loc=[sk[4], sk[5]])
        self.add_JJ(name='J1', c=1, A=1.37, B=0, loc=[sk[5], sk[6]])
        self.add_JJ(name='J2', c=1, A=1.37, B=0, loc=[sk[5], 0])
        self.add_JJ(name='J3', c=1, A=1.37, B=0, loc=[sk[9], sk[11]])
        self.add_JJ(name='J4', c=1, A=1.37, B=0, loc=[sk[11], 0])
        self.add_JJ(name='J5', c=1, A=1.5, B=0, loc=[sk[11], sk[12]])
        self.add_JJ(name='J6', c=1, A=1.54, B=0, loc=[sk[13], sk[14]])
        self.add_JJ(name='J7', c=1, A=1.77, B=0, loc=[sk[15], sk[14]])
        self.add_JJ(name='J8', c=1, A=1.37, B=0, loc=[sk[14], 0])

        self.add_L(name='L0', val=1, loc=[sk[0], sk[4]])
        self.add_L(name='L1', val=3.5, loc=[sk[6], sk[10]])
        self.add_L(name='L2', val=3.5, loc=[sk[10], sk[9]])
