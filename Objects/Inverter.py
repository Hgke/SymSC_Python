...
class Inverter(ComplexObjectBase):
    ...
    def create_elements(self, sk):
        ...
        self.add_JJ(name='J1', A=2.01, B=0, c=1, loc=[sk[3], sk[4]])
        self.add_JJ(name='J2', A=2.48, B=0, c=1, loc=[sk[7], sk[8]])
        self.add_JJ(name='J3', A=1.12, B=0, c=1, loc=[sk[7], sk[9]])
        self.add_JJ(name='J4', A=1.4, B=0, c=1, loc=[sk[10], sk[11]])
        self.add_JJ(name='J5', A=2.35, B=0, c=1, loc=[sk[15], sk[16]])
        self.add_JJ(name='J6', A=2.84, B=0, c=1, loc=[sk[19], sk[20]])
        self.add_JJ(name='J7', A=2.35, B=0, c=1, loc=[sk[21], sk[22]])
        self.add_JJ(name='J8', A=2.11, B=0, c=1, loc=[sk[25], sk[26]])
